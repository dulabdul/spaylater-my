...
export const WHATSAPP_URL =
  'https://api.whatsapp.com/send/?phone=+601127312179&text=Halo+Admin%2C+saya+nak+cashout&type=phone_number&app_absent=0';
export const INSTAGRAM_URL =
  'https://www.instagram.com/cashoutby.sakinah?igsh=OWRrbWVmNWF6c3Bs';
