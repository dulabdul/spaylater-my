    ...
    <footer className='bg-gray-900 text-white py-12'>
      <div className='container mx-auto px-4 text-center'>
        ...
        <p className='mb-6 text-gray-400 max-w-md mx-auto'>
          Solusi pencairan had PayLater yang dipercayai, pantas, dan selamat.
          Hubungi kami untuk bantuan segera.
        </p>
        ...
        <div className='border-t border-gray-800 pt-8 text-sm text-gray-500'>
          &copy; {new Date().getFullYear()} nakcashoutservice.my.my. All rights
          reserved.
        </div>
      </div>
    </footer>
